    ...
    <tbody>
        <?php 
                    ...
                    $sql="SELECT
                        ...
                        cast(`a`.`nun_bing` AS decimal(10,2)) as `c2`,
                        cast(`a`.`avgmat` AS decimal(10,2)) as `c4`,
                        cast(`a`.`avgbind` AS decimal(10,2)) as `c5`,
                        cast(`a`.`avgbing` AS decimal(10,2)) as `c6`,
                        cast(`a`.`avgipa` AS decimal(10,2)) as `c7`,
                        cast(`a`.`avgips` AS decimal(10,2)) as `c8`,
                        cast(`a`.`avgaga` AS decimal(10,2)) as `c9`,
