...
<div class="row">
	<div class="col-3"><button type="button" class="btn btn-primary">AWAL</button>	</div>
	<div class="col-6"></div>		
	<div class="col-3"><button type="button" class="btn btn-info float-right">LANJUT</button>	</div>
</div>
